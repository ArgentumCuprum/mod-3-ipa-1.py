...
def caesar_cipher(message, shift):
    ...
    for i in list(message):
        if i == " ":
            ...
            old_letter_index = alphabet.index(i)
            new_letter_index = old_letter_index + shift
            if new_letter_index <= 25:
                a_list.append(alphabet[new_letter_index])
            else:
                while new_letter_index > 25:
                    new_letter_index = new_letter_index - 26
                a_list.append(alphabet[new_letter_index])
...
def shift_by_letter(letter, letter_shift):
    ...
    if letter == " ":
        ...
        new_letter_index = old_letter_index + shift_index
        if new_letter_index <= 25:
            return alphabet[new_letter_index]
        else:
            while new_letter_index > 25:
...
def scytale_cipher(message, shift):
    ...
    for i in range(n):
        row = i // columns
        col = i % columns
        ciphertext[col * shift + row] = char_list[i]
